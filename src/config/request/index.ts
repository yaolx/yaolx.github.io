...
function httpErrorStatusHandle(error) {
  ...
  if (error && error.response) {
    switch(error.response.status) {
      case 302: messageText = '接口重定向了！';break;
      case 400: messageText = '参数不正确！';break;
      case 401: messageText = '您未登录，或者登录已经超时，请先登录！';break;
      case 403: messageText = '您没有权限操作！'; break;
      case 404: messageText = `请求地址出错: ${error.response.config.url}`; break; // 在正确域名下
      case 408: messageText = '请求超时！'; break;
      case 409: messageText = '系统已存在相同数据！'; break;
      case 500: messageText = '服务器内部错误！'; break;
      case 501: messageText = '服务未实现！'; break;
      case 502: messageText = '网关错误！'; break;
      case 503: messageText = '服务不可用！'; break;
      case 504: messageText = '服务暂时无法访问，请稍后再试！'; break;
      case 505: messageText = 'HTTP版本不受支持！'; break;
      default: messageText = '异常问题，请联系管理员！'; break
    }
  }
